<template>
  <div class="flex items-center justify-center gap-x-3">
    ...
    <IconPark :icon="isPlaying?PauseOne:Play" size="45" theme="filled" class="hover-text text-emerald-400"
              @click="togglePlay"/>
...
const {toggleLoop, loopType, next,prev, togglePlay, isPlaying} = toRefs(usePlayerStore())
