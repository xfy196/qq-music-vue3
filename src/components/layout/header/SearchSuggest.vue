<template>
  <div v-for="order in suggestData?.order" :key="order">
    ...
    <template v-for="item in suggestData.songs" :key="item.id">
      <div
        v-if="order === 'songs'"
    ...
    <template v-for="item in suggestData.albums" :key="item.id">
      <div
        v-if="order === 'albums'"
        class="py-1.5 px-2.5 hover-bg-main text-xs cursor-pointer"
    ...
    <template v-for="item in suggestData.artists" :key="item.id">
      <div
        v-if="order === 'artists'"
        class="
          py-1.5
    ...
    <template v-for="item in suggestData.playlists" :key="item.id">
      <div
